    ...
    return {
        init: function() {
            ...
            $email.on('focus', function() {
                $span.eq(3).html('请输入正确的邮箱').css('color', '#333');
            });
            ...
            $email.on('blur', function() {
                ...
                if ($value !== '') {
                    ...
                    if ($reg.test($value)) {
                        ...
                        $span.eq(3).html('邮件格式有误').css('color', 'red');
                        $telflag = false;
                    }
                } else {
                    $span.eq(3).html('邮件不能为空').css('color', 'red');
                    $emailflag = false;
                }
            });
            ...
            let $titles = $('.tab_title li'); //5个标题
            let $contents = $('.tab_content .item'); //5块内容
